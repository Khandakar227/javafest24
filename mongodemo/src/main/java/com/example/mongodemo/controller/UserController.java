...
import com.example.mongodemo.model.JwtTokenResponse;
import com.example.mongodemo.model.Response;
import com.example.mongodemo.model.User;
import com.example.mongodemo.repository.AuthRepository;
import com.example.mongodemo.repository.UserRepository;
import com.example.mongodemo.service.EmailService;
...
public class UserController {
    ...
    public String resetPassword(@PathVariable String token, @RequestParam String password) {
        try {
            ...
            existingUser.setPassword(authRepository.hashPassword(password));
            userRepository.save(existingUser);
