...
public class AuthController {
    ...
    private static final String AUTH0_TOKEN_URL = "https://dev-learnloom.us.auth0.com/oauth/token";

    @GetMapping(value = "/api/auth/login")
    protected void login(HttpServletRequest request, HttpServletResponse response) throws IOException {
        String redirectUri = config.getContextPath(request) + "/api/auth/callback";
    ...
    @GetMapping(value="/api/auth/callback")
    ...
    public String getManagementApiToken() {
        ...
        System.out.println(config.getManagementApiClientId());
        ...
        requestBody.put("audience", "https://dev-learnloom.us.auth0.com/api/v2/");
