...
export default function MaleMuscleBack(props: SVGProps<SVGSVGElement>) {
    ...
    return (
        ...
        <g id="hamstrings" className={`bodymap text-mw-gray active:text-red-700 hover:text-green-950 ${router.query.muscleGrp == 'hamstrings' && ('text-green-950')}`} onClick={(e)=>getMuscle(e, 'male')}>
            <path
        ...
        <g id="glutes" className={`bodymap text-mw-gray active:text-red-700 hover:text-green-950 ${router.query.muscleGrp == 'glutes' && ('text-green-950')}`} onClick={(e)=>getMuscle(e, 'male')}>
            <path
        ...
        <g id="triceps" className={`bodymap text-mw-gray active:text-red-700 hover:text-green-950 ${router.query.muscleGrp == 'triceps' && ('text-green-950')}`} onClick={(e)=>getMuscle(e, 'male')}>
            <path
        ...
        <g id="lats" className={`bodymap text-mw-gray active:text-red-700 hover:text-green-950 ${router.query.muscleGrp == 'lats' && ('text-green-950')}`} onClick={(e)=>getMuscle(e, 'male')}>
            <path
        ...
        <g id="lowerback" className={`bodymap text-mw-gray active:text-red-700 hover:text-green-950 ${router.query.muscleGrp == 'lowerback' && ('text-green-950')}`} onClick={(e)=>getMuscle(e, 'male')}>
            <path
        ...
        <g id="traps-middle" className={`bodymap text-mw-gray active:text-red-700 hover:text-green-950 ${router.query.muscleGrp == 'traps-middle' && ('text-green-950')}`} onClick={(e)=>getMuscle(e, 'male')}>
            <path
        ...
        <g id="body" className="body-map__model">
            <path d="M266.34,935.47c-.89-19.84-16.47-25.12-28.26-16.43-14.11,10.4-36.12-39.53-43.56-12.29" fill="none"
             strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.52"></path>
            ...
            <path d="M146.43,292.74s7.92-6.67,16.02-7.1c8.1-.43,32.12-.43,50.22-15.45,18.1-15.01,34.72-25.92,50.42-40.9"
                fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.52"></path>
            <path
                d="M306.02,320.31c16.1,39.45,8.58,62.94-20.42,117.65-15.8,29.81,7.37,62.98-19.95,73.7-17.48,6.86-43.08,23.91-44.85,40.85"
                fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.52"></path>
            <path d="M199.54,339.06c7.74-12.38-13.12-52.58,0-60.72" fill="none" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.52"></path>
            <path
            ...
            <path
                ...
                fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.52"></path>
            <path d="M460.98,339.06c-7.74-12.38,13.12-52.58,0-60.72" fill="none" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.52"></path>
            <path
                d="M330.26,614.06c0,35.81,24.38,31.69,49.78,30.16,27.16-1.64,63.32-19.3,43.62-80.18-8.85-27.35-8.53-46.89-35.82-54.97-19.3-5.72-57.58-4.57-57.58,44.65"
                fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.52"></path>
            ...
            <path
                ...
                fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.52"></path>
            <line x1="330.26" y1="553.71" x2="330.26" y2="614.06" fill="none" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.52"></line>
            <path
            ...
            <g>
                <path
                    ...
                    fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.52">
                </path>
                <path
        ...
        <g id="ankles" className="hidden">
            <ellipse id="hover-9" data-name="hover" cx="445.81" cy="1119.64" rx="25.53" ry="25.24"
                fill="url(#jointradial)" opacity="1" strokeWidth="0"></ellipse>
            <ellipse id="hover-8" data-name="hover" cx="214.71" cy="1119.64" rx="25.53" ry="25.24"
                fill="url(#jointradial)" opacity="1" strokeWidth="0"></ellipse>
            <ellipse cx="214.71" cy="1119.64" rx="12.44" ry="12.3" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.52"></ellipse>
            <ellipse cx="445.81" cy="1119.64" rx="12.44" ry="12.3" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.52"></ellipse>
        </g>
        <g id="knees" className="hidden">
            <ellipse id="hover-7" data-name="hover" cx="237.16" cy="879.63" rx="25.53" ry="25.24"
                fill="url(#jointradial)" opacity="1" strokeWidth="0"></ellipse>
            <ellipse id="hover-10" data-name="hover" cx="423.36" cy="879.63" rx="25.53" ry="25.24"
                fill="url(#jointradial)" opacity="1" strokeWidth="0"></ellipse>
            <ellipse cx="423.36" cy="879.63" rx="12.44" ry="12.3" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.52"></ellipse>
            <ellipse cx="237.16" cy="879.63" rx="12.44" ry="12.3" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.52"></ellipse>
        </g>
        <g id="wrist" className="hidden">
            <ellipse id="hover-6" data-name="hover" cx="30.54" cy="548.63" rx="25.53" ry="25.24"
                fill="url(#jointradial)" opacity="1" strokeWidth="0"></ellipse>
            <ellipse id="hover-11" data-name="hover" cx="629.98" cy="548.63" rx="25.53" ry="25.24"
                fill="url(#jointradial)" opacity="1" strokeWidth="0"></ellipse>
            <ellipse cx="629.98" cy="548.63" rx="12.44" ry="12.3" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.52"></ellipse>
            <ellipse cx="30.54" cy="548.63" rx="12.44" ry="12.3" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.52"></ellipse>
        </g>
        <g id="elbow" className="hidden">
            <ellipse id="hover-5" data-name="hover" cx="119.84" cy="396.23" rx="25.53" y="25.24"
                fill="url(#jointradial)" opacity="1" strokeWidth="0"></ellipse>
            <ellipse id="hover-12" data-name="hover" cx="540.68" cy="396.23" rx="25.53" ry="25.24"
                fill="url(#jointradial)" opacity="1" strokeWidth="0"></ellipse>
            <ellipse cx="540.68" cy="396.23" rx="12.44" ry="12.3" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.52"></ellipse>
            <ellipse cx="119.84" cy="396.23" rx="12.44" ry="12.3" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.52"></ellipse>
        </g>
        <g id="upper-spine" className="hidden">
            <ellipse id="hover" cx="330.26" cy="209.3" rx="25.53" ry="25.24" fill="url(#jointradial)" opacity="1"
                strokeWidth="0"></ellipse>
            <ellipse cx="330.26" cy="209.3" rx="12.44" ry="12.3" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.52"></ellipse>
        </g>
        <g id="scapula" className="hidden">
            <ellipse id="hover-2" data-name="hover" cx="240.12" cy="271.32" rx="25.53" ry="25.24"
                fill="url(#jointradial)" opacity="1" strokeWidth="0"></ellipse>
            <ellipse id="hover-3" data-name="hover" cx="420.4" cy="271.32" rx="25.53" ry="25.24"
                fill="url(#jointradial)" opacity="1" strokeWidth="0"></ellipse>
            <ellipse cx="420.4" cy="271.32" rx="12.44" ry="12.3" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.52"></ellipse>
            <ellipse cx="240.12" cy="271.32" rx="12.44" ry="12.3" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.52"></ellipse>
        </g>
        <g id="lower-spine" className="hidden">
            <ellipse id="hover-4" data-name="hover" cx="330.26" cy="491.77" rx="25.53" ry="25.24"
                fill="url(#jointradial)" opacity="1" strokeWidth="0"></ellipse>
            <ellipse cx="330.26" cy="491.77" rx="12.44" ry="12.3" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.52"></ellipse>
        </g>
    </svg>
    )
