...
export default function FemaleMuscleFront() {
    function getMuscle(e:MouseEvent) {
        console.dir((e.target as SVGElement).parentElement?.id)

    }

  return (
    <svg viewBox="0 0 660.46 1206.46" fill="none" xmlns="http://www.w3.org/2000/svg"
        className="max-w-64 mx-auto object-fit text-green-700">
        <defs>
        ...
        <g id="calves" className="bodymap text-mw-gray active:text-mw-red-700 hover:text-green-900" onClick={getMuscle}>
            <path
        ...
        <g id="quads" className="bodymap text-mw-gray active:text-mw-red-700 hover:text-green-900" onClick={getMuscle}>
            <path
        ...
        <g id="obliques" className="bodymap text-mw-gray active:text-mw-red-700 hover:text-green-900" onClick={getMuscle}>
            <path
        ...
        <g id="abdominals" className="bodymap text-mw-gray active:text-mw-red-700 hover:text-green-900" onClick={getMuscle}>
            <path
        ...
        <g id="hands" className="bodymap text-mw-gray active:text-mw-red-700 hover:text-green-900" onClick={getMuscle}>
            <path
        ...
        <g id="forearms" className="bodymap text-mw-gray active:text-mw-red-700 hover:text-green-900" onClick={getMuscle}>
            <path
        ...
        <g id="biceps" className="bodymap text-mw-gray active:text-mw-red-700 hover:text-green-900" onClick={getMuscle}>
            <path
        ...
        <g id="chest" className="bodymap text-mw-gray active:text-mw-red-700 hover:text-green-900" onClick={getMuscle}>
            <path
        ...
        <g id="front-shoulders" className="bodymap text-mw-gray active:text-mw-red-700 hover:text-green-900" onClick={getMuscle}>
            <path
        ...
        <g id="traps" className="bodymap text-mw-gray active:text-mw-red-700 hover:text-green-900" onClick={getMuscle}>
            <path
