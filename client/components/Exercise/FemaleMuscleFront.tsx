...
export default function FemaleMuscleFront() {
  ...
  return (
    <svg viewBox="0 0 660.46 1206.46" fill="none" xmlns="http://www.w3.org/2000/svg"
        ...
        <g id="calves" className="bodymap text-mw-gray active:text-mw-red-700 hover:text-green-950" onClick={getMuscle}>
            <path
        ...
        <g id="quads" className="bodymap text-mw-gray active:text-mw-red-700 hover:text-green-950" onClick={getMuscle}>
            <path
        ...
        <g id="obliques" className="bodymap text-mw-gray active:text-mw-red-700 hover:text-green-950" onClick={getMuscle}>
            <path
        ...
        <g id="abdominals" className="bodymap text-mw-gray active:text-mw-red-700 hover:text-green-950" onClick={getMuscle}>
            <path
        ...
        <g id="hands" className="bodymap text-mw-gray active:text-mw-red-700 hover:text-green-950" onClick={getMuscle}>
            <path
        ...
        <g id="forearms" className="bodymap text-mw-gray active:text-mw-red-700 hover:text-green-950" onClick={getMuscle}>
            <path
        ...
        <g id="biceps" className="bodymap text-mw-gray active:text-mw-red-700 hover:text-green-950" onClick={getMuscle}>
            <path
        ...
        <g id="chest" className="bodymap text-mw-gray active:text-mw-red-700 hover:text-green-950" onClick={getMuscle}>
            <path
        ...
        <g id="shoulders" className="bodymap text-mw-gray active:text-mw-red-700 hover:text-green-950" onClick={getMuscle}>
            <path
        ...
        <g id="traps" className="bodymap text-mw-gray active:text-mw-red-700 hover:text-green-950" onClick={getMuscle}>
            <path
