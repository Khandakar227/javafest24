import { getMuscle } from "@/lib/get-muscle"
import { useRouter } from "next/router";

export default function FemaleMuscleFront() {
    const router = useRouter();

  return (
    <svg viewBox="0 0 660.46 1206.46" fill="none" xmlns="http://www.w3.org/2000/svg"
        className="max-w-64 mx-auto w-full text-green-700">
        <defs>
        ...
        <g id="calves" className={`bodymap text-mw-gray active:text-red-700 hover:text-green-950 ${router.query.muscleGrp == 'calves' && ('text-green-950')}`} onClick={(e) => getMuscle(e, 'female')}>
            <path
        ...
        <g id="quads" className={`bodymap text-mw-gray active:text-red-700 hover:text-green-950 ${router.query.muscleGrp == 'quads' && ('text-green-950')}`} onClick={(e) => getMuscle(e, 'female')}>
            <path
        ...
        <g id="obliques" className={`bodymap text-mw-gray active:text-red-700 hover:text-green-950 ${router.query.muscleGrp == 'obliques' && ('text-green-950')}`} onClick={(e) => getMuscle(e, 'female')}>
            <path
        ...
        <g id="abdominals" className={`bodymap text-mw-gray active:text-red-700 hover:text-green-950 ${router.query.muscleGrp == 'abdominals' && ('text-green-950')}`} onClick={(e) => getMuscle(e, 'female')}>
            <path
        ...
        <g id="hands" className={`bodymap text-mw-gray active:text-red-700 hover:text-green-950 ${router.query.muscleGrp == 'hands' && ('text-green-950')}`} onClick={(e) => getMuscle(e, 'female')}>
            <path
        ...
        <g id="forearms" className={`bodymap text-mw-gray active:text-red-700 hover:text-green-950 ${router.query.muscleGrp == 'forearms' && ('text-green-950')}`} onClick={(e) => getMuscle(e, 'female')}>
            <path
        ...
        <g id="biceps" className={`bodymap text-mw-gray active:text-red-700 hover:text-green-950 ${router.query.muscleGrp == 'biceps' && ('text-green-950')}`} onClick={(e) => getMuscle(e, 'female')}>
            <path
            ...
            <path
                ...
                fill="none" stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.58"></path>
        </g>
        <g id="chest" className={`bodymap text-mw-gray active:text-red-700 hover:text-green-950 ${router.query.muscleGrp == 'chest' && ('text-green-950')}`} onClick={(e) => getMuscle(e, 'female')}>
            <path
        ...
        <g id="shoulders" className={`bodymap text-mw-gray active:text-red-700 hover:text-green-950 ${router.query.muscleGrp == 'shoulders' && ('text-green-950')}`} onClick={(e) => getMuscle(e, 'female')}>
            <path
        ...
        <g id="traps" className={`bodymap text-mw-gray active:text-red-700 hover:text-green-950 ${router.query.muscleGrp == 'traps' && ('text-green-950')}`} onClick={(e) => getMuscle(e, 'female')}>
            <path
        ...
        <g id="body" className="body-map__model">
            <g>
                <path d="M45.19,477.27c-.19,4.9.64,11.2,4.99,15.56,4.82,4.84,12.11,4.7,17.22,3.82h.02" fill="none"
                    stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.58"></path>
                <path d="M229.09,220.64s1.82,0,30.21,3.82c1.76.24,2.75,1.93,1.43,3.09-9.4,8.31-31.62,28.69-61.72,61.05"
                    fill="none" stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.58">
                </path>
                <path
                ...
                <path d="M227.26,496.73c13.71,4.51,32.97,5.65,46.48,32.63,31.54,62.98,56.25,64.72,56.25,80.31"
                    fill="none" stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.58">
                </path>
                <path
            ...
            <g>
                ...
                <path d="M291.2,368.05c12.44-4.14,20.9-6.63,33.23-6.35,5.35-.02,5.35-8.97,5.35-18.63" fill="none"
                    stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.58"></path>
                <path d="M293.62,413.75c13.83.25,26.66.64,33.36-3.7,4.13-2.68,2.8-10.32,2.8-19.37" fill="none"
                    stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.58"></path>
                <path d="M294.94,460.98c12.8.52,15.43,1.57,27.43,1.18,6.4-.54,7.4-3.66,7.4-19.06" fill="none"
                    stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.58"></path>
                <path d="M301.92,370.06c4.32-1.28,13.04-4.2,20.08-2.83s7.78,6.49,7.78,12.43" fill="none"
                    stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.58"></path>
                <path d="M301.92,418.82c5.68-.75,13.28-1.71,20.22-1.61,6.94.11,7.63,5.36,7.63,13.72" fill="none"
                    stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.58"></path>
                <line x1="329.98" y1="494.08" x2="329.98" y2="560.62" fill="none" stroke="none"
                    strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.58"></line>
                <path d="M301.92,467.17c5.2-.12,18.71,1.37,23.5,2.61,4.79,1.24,4.56,7.96,4.56,13.81" fill="none"
                    stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.58"></path>
            </g>
            <path d="M24.03,558.61s-3.51,7.17-4.34,9.48-3.07,8.34-3.08,10.92c0,2.58,10.02,19.71-.68,20.32" fill="none"
                stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.58"></path>
            <path
                ...
                fill="none" stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.58"></path>
            <path d="M615.39,477.27c.19,4.9-.64,11.2-4.99,15.56-4.82,4.84-12.11,4.7-17.22,3.82h-.02" fill="none"
                stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.58"></path>
            <path d="M431.49,220.64s-1.82,0-30.21,3.82c-1.76.24-2.75,1.93-1.43,3.09,9.4,8.31,31.62,28.69,61.72,61.05"
                fill="none" stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.58"></path>
            <path
            ...
            <path
                ...
                fill="none" stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.58"></path>
            <path d="M433.32,496.73c-13.71,4.51-32.97,5.65-46.48,32.63-31.54,62.98-56.25,64.72-56.25,80.31" fill="none"
                stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.58"></path>
            <path
            ...
            <g>
                ...
                <path d="M369.38,368.05c-12.44-4.14-20.9-6.63-33.23-6.35-5.35-.02-5.35-8.97-5.35-18.63" fill="none"
                    stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.58"></path>
                <path d="M366.96,413.75c-13.83.25-26.66.64-33.36-3.7-4.13-2.68-2.8-10.32-2.8-19.37" fill="none"
                    stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.58"></path>
                <path d="M365.64,460.98c-12.8.52-15.43,1.57-27.43,1.18-6.4-.54-7.4-3.66-7.4-19.06" fill="none"
                    stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.58"></path>
                <path d="M358.66,370.06c-4.32-1.28-13.04-4.2-20.08-2.83-7.04,1.37-7.78,6.49-7.78,12.43" fill="none"
                    stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.58"></path>
                <path d="M358.66,418.82c-5.68-.75-13.28-1.71-20.22-1.61-6.94.11-7.63,5.36-7.63,13.72" fill="none"
                    stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.58"></path>
                <line x1="330.6" y1="494.08" x2="330.6" y2="560.62" fill="none" stroke="none" strokeLinecap="round"
                    strokeLinejoin="round" strokeWidth="3.58"></line>
                <path d="M358.66,467.17c-5.2-.12-18.71,1.37-23.5,2.61-4.79,1.24-4.56,7.96-4.56,13.81" fill="none"
                    stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.58"></path>
            </g>
            <path d="M636.55,558.61s3.51,7.17,4.34,9.48c.83,2.31,3.07,8.34,3.08,10.92,0,2.58-10.02,19.71.68,20.32"
                fill="none" stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.58"></path>
            <path
                ...
                fill="none" stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.58"></path>
            <path d="M379.61,97.79s10.76-3.74,9.77,12.16c-1.01,15.9-9.79,23.04-15.57,19.9" fill="none" stroke="none"
                strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.58"></path>
            <path d="M280.97,97.79s-10.76-3.74-9.77,12.16c1.01,15.9,9.79,23.04,15.57,19.9" fill="none" stroke="none"
                strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.58"></path>
            <path
                ...
                fill="none" stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.58"></path>
            <g>
                <path d="M367,149.3s-5.6,19.62-36.4,24.98" fill="none" stroke="none" strokeLinecap="round"
                    strokeLinejoin="round" strokeWidth="3.58"></path>
                <path d="M293.57,149.3s5.6,19.62,36.4,24.98" fill="none" stroke="none" strokeLinecap="round"
                    strokeLinejoin="round" strokeWidth="3.58"></path>
            </g>
            <path
            ...
            <path
                ...
                fill="none" stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.58"></path>
            <path d="M328.54,37.06c8.1,12.59,17.04,19.33,29.18,25.88,20.83,11.22,23.06,21.93,21.91,44.13" fill="none"
                stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.58"></path>
            <path d="M364.43,47.89c3.82,10.01,17.37,32.08,15.21,54.64" fill="none" stroke="none"
                strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.58"></path>
            <path d="M294.97,54.31c-9.45,8.76-14.9,30.21-14.5,51.24" fill="none" stroke="none" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.58"></path>
        </g>
        <g id="shoulders" className="hidden">
            <ellipse id="hover" cx="230.39" cy="254.57" rx="26.19" ry="25.49" fill="url(#jointradial)" opacity="1"
                strokeWidth="0"></ellipse>
            <ellipse cx="430.19" cy="254.57" rx="26.19" ry="25.49" fill="url(#jointradial)" opacity="1"
                strokeWidth="0"></ellipse>
            <ellipse cx="230.39" cy="254.57" rx="12.76" ry="12.42" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.58"></ellipse>
            <ellipse cx="430.19" cy="254.57" rx="12.76" ry="12.42" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.58"></ellipse>
        </g>
        <g id="hips" className="hidden">
            <ellipse cx="254.33" cy="500.07" rx="26.19" ry="25.49" fill="url(#jointradial)" opacity="1"
                strokeWidth="0"></ellipse>
            <ellipse id="hover-8" data-name="hover" cx="406.25" cy="500.07" rx="26.19" ry="25.49"
                fill="url(#jointradial)" opacity="1" strokeWidth="0"></ellipse>
            <ellipse cx="406.25" cy="500.07" rx="12.76" ry="12.42" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.58"></ellipse>
            <ellipse cx="254.33" cy="500.07" rx="12.76" ry="12.42" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.58"></ellipse>
        </g>
        <g id="knees" className="hidden">
            <ellipse cx="239.96" cy="867.71" rx="26.19" ry="25.49" fill="url(#jointradial)" opacity="1"
                strokeWidth="0"></ellipse>
            <ellipse cx="420.62" cy="867.71" rx="26.19" ry="25.49" fill="url(#jointradial)" opacity="1"
                strokeWidth="0"></ellipse>
            <ellipse cx="420.62" cy="867.71" rx="12.76" ry="12.42" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.58"></ellipse>
            <ellipse cx="239.96" cy="867.71" rx="12.76" ry="12.42" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.58"></ellipse>
        </g>
        <g id="ankles" className="hidden">
            <ellipse cx="444.56" cy="1113.44" rx="26.19" ry="25.49" fill="url(#jointradial)" opacity="1"
                strokeWidth="0"></ellipse>
            <ellipse cx="216.02" cy="1113.44" rx="26.19" ry="25.49" fill="url(#jointradial)" opacity="1"
                strokeWidth="0"></ellipse>
            <ellipse cx="444.56" cy="1113.44" rx="12.76" ry="12.42" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.58"></ellipse>
            <ellipse cx="216.02" cy="1113.44" rx="12.76" ry="12.42" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.58"></ellipse>
        </g>
        <g id="wrist" className="hidden">
            <ellipse cx="608.5" cy="492.26" rx="26.19" ry="25.49" fill="url(#jointradial)" opacity="1" strokeWidth="0">
            </ellipse>
            <ellipse cx="52.08" cy="492.26" rx="26.19" ry="25.49" fill="url(#jointradial)" opacity="1" strokeWidth="0">
            </ellipse>
            <ellipse cx="608.5" cy="492.26" rx="12.76" ry="12.42" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.58"></ellipse>
            <ellipse cx="52.08" cy="492.26" rx="12.76" ry="12.42" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.58"></ellipse>
        </g>
        <g id="elbow" className="hidden">
            <ellipse cx="134.9" cy="396.71" rx="26.19" ry="25.49" fill="url(#jointradial)" opacity="1" strokeWidth="0">
            </ellipse>
            <ellipse cx="525.68" cy="396.71" rx="26.19" ry="25.49" fill="url(#jointradial)" opacity="1"
                strokeWidth="0"></ellipse>
            <ellipse cx="525.68" cy="396.71" rx="12.76" ry="12.42" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.58"></ellipse>
            <ellipse cx="134.9" cy="396.71" rx="12.76" ry="12.42" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.58"></ellipse>
        </g>
    </svg>
  )
