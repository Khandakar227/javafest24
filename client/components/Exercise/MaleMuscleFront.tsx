...
export default function MaleMuscleFront() {
  ...
  return (
    <svg viewBox="0 0 660.46 1206.46" fill="none" xmlns="http://www.w3.org/2000/svg"
        ...
        <g id="calves" className={`bodymap text-mw-gray active:text-red-700 hover:text-green-950 ${router.query.muscleGrp == 'calves' && ('text-green-950')}`} onClick={(e)=>getMuscle(e, 'male')}>
            <path
        ...
        <g id="quads" className={`bodymap text-mw-gray active:text-red-700 hover:text-green-950 ${router.query.muscleGrp == 'quads' && ('text-green-950')}`} onClick={(e)=>getMuscle(e, 'male')}>
            <path
        ...
        <g id="abdominals" className={`bodymap text-mw-gray active:text-red-700 hover:text-green-950 ${router.query.muscleGrp == 'abdominals' && ('text-green-950')}`} onClick={(e)=>getMuscle(e, 'male')}>
            <path
        ...
        <g id="obliques" className={`bodymap text-mw-gray active:text-red-700 hover:text-green-950 ${router.query.muscleGrp == 'obliques' && ('text-green-950')}`} onClick={(e)=>getMuscle(e, 'male')}>
            <path
        ...
        <g id="hands" className={`bodymap text-mw-gray active:text-red-700 hover:text-green-950 ${router.query.muscleGrp == 'hands' && ('text-green-950')}`} onClick={(e)=>getMuscle(e, 'male')}>
            <path
        ...
        <g id="forearms" className={`bodymap text-mw-gray active:text-red-700 hover:text-green-950 ${router.query.muscleGrp == 'forearms' && ('text-green-950')}`} onClick={(e)=>getMuscle(e, 'male')}>
            <path
        ...
        <g className={`bodymap text-mw-gray active:text-red-700 hover:text-green-950 ${router.query.muscleGrp == 'biceps' && ('text-green-950')}`} onClick={(e)=>getMuscle(e, 'male')} id="biceps">
            <path
        ...
        <g id="shoulders" className={`bodymap text-mw-gray active:text-red-700 hover:text-green-950 ${router.query.muscleGrp == 'shoulders' && ('text-green-950')}`} onClick={(e)=>getMuscle(e, 'male')}>
            <path
        ...
        <g id="chest" className={`bodymap text-mw-gray active:text-red-700 hover:text-green-950 ${router.query.muscleGrp == 'chest' && ('text-green-950')}`} onClick={(e)=>getMuscle(e, 'male')}>
            <path
        ...
        <g id="traps" className={`bodymap text-mw-gray active:text-red-700 hover:text-green-950 ${router.query.muscleGrp == 'traps' && ('text-green-950')}`} onClick={(e)=>getMuscle(e, 'male')}>
            <path
        ...
        <g id="body" className="body-map__model">
            <line x1="330.4" y1="504.57" x2="330.4" y2="571.92" fill="none" stroke="none" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.46"></line>
            <line x1="330.17" y1="504.57" x2="330.17" y2="571.92" fill="none" stroke="none" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.46"></line>
            <line x1="330.05" y1="504.57" x2="330.05" y2="571.92" fill="none" stroke="none" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.46"></line>
            <path d="M29,521.95v.02c1.13,7.67,5.05,13.92,10.29,16.59,4.74,2.41,10.96,2.08,17.03-.58" fill="none"
                stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
            <path
                ...
                fill="none" stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
            <path
                d="M165.89,397.13c-18.42,22.99-34.28,22.87-41.87,19.05-12.72-6.41-19.87-27.43,3.8-80.98,0-.02,0-.05.02-.07"
                fill="none" stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
            <path d="M163.96,299.82h.04" fill="none" stroke="none" strokeLinecap="round" strokeLinejoin="round"
            ...
            <path d="M298.53,428.4c6.43-.76,15.03-1.74,22.89-1.63,7.86.11,8.64,5.42,8.64,13.89" fill="none"
                stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
            <line x1="330.29" y1="504.57" x2="330.29" y2="571.92" fill="none" stroke="none" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.46"></line>
            ...
            <path
                ...
                fill="none" stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
            <path d="M496.5,299.82h-.04" fill="none" stroke="none" strokeLinecap="round" strokeLinejoin="round"
                strokeWidth="3.46"></path>
            <path
            ...
            <path
                ...
                fill="none" stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.46"></path>
            <g>
                <path d="M370.84,135.77s-10.57,20.48-40.26,25.91" fill="none" stroke="none" strokeLinecap="round"
                    strokeLinejoin="round" strokeWidth="3.46"></path>
                <path d="M289.97,135.77s10.57,20.48,40.26,25.91" fill="none" stroke="none" strokeLinecap="round"
                    strokeLinejoin="round" strokeWidth="3.46"></path>
            </g>
            <path
        ...
        <g id="shoulders" className="hidden">
            <ellipse id="hover-2" data-name="hover" cx="441.13" cy="261.13" rx="24.71" ry="25.24"
                fill="url(#jointradial)" opacity="1" strokeWidth="0"></ellipse>
            <ellipse id="hover" cx="219.33" cy="261.13" rx="24.71" ry="25.24" fill="url(#jointradial)" opacity="1"
                strokeWidth="0"></ellipse>
            <ellipse cx="441.13" cy="261.13" rx="12.04" ry="12.3" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.46"></ellipse>
            <ellipse cx="219.33" cy="261.13" rx="12.04" ry="12.3" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.46"></ellipse>
        </g>
        <g id="elbow" className="hidden">
            <ellipse id="hover-3" data-name="hover" cx="118.6" cy="412.77" rx="24.71" ry="25.24"
                fill="url(#jointradial)" opacity="1" strokeWidth="0"></ellipse>
            <ellipse id="hover-7" data-name="hover" cx="541.86" cy="412.77" rx="24.71" ry="25.24"
                fill="url(#jointradial)" opacity="1" strokeWidth="0"></ellipse>
            <ellipse cx="541.86" cy="412.77" rx="12.04" ry="12.3" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.46"></ellipse>
            <ellipse cx="118.6" cy="412.77" rx="12.04" ry="12.3" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.46"></ellipse>
        </g>
        <g id="wrist" className="hidden">
            <ellipse id="hover-4" data-name="hover" cx="42.41" cy="531.02" rx="24.71" ry="25.24"
                fill="url(#jointradial)" opacity="1" strokeWidth="0"></ellipse>
            <ellipse id="hover-8" data-name="hover" cx="618.05" cy="531.02" rx="24.71" ry="25.24"
                fill="url(#jointradial)" opacity="1" strokeWidth="0"></ellipse>
            <ellipse cx="618.05" cy="531.02" rx="12.04" ry="12.3" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.46"></ellipse>
            <ellipse cx="42.41" cy="531.02" rx="12.04" ry="12.3" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.46"></ellipse>
        </g>
        <g id="hips" className="hidden">
            <ellipse id="hover-6" data-name="hover" cx="412.75" cy="523.37" rx="24.71" ry="25.24"
                fill="url(#jointradial)" opacity="1" strokeWidth="0"></ellipse>
            <ellipse id="hover-5" data-name="hover" cx="247.71" cy="523.37" rx="24.71" ry="25.24"
                fill="url(#jointradial)" opacity="1" strokeWidth="0"></ellipse>
            <ellipse cx="412.75" cy="523.37" rx="12.04" ry="12.3" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.46"></ellipse>
            <ellipse cx="247.71" cy="523.37" rx="12.04" ry="12.3" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.46"></ellipse>
        </g>
        <g id="knees" className="hidden">
            <ellipse id="hover-10" data-name="hover" cx="419.37" cy="874.7" rx="24.71" ry="25.24"
                fill="url(#jointradial)" opacity="1" strokeWidth="0"></ellipse>
            <ellipse id="hover-9" data-name="hover" cx="241.09" cy="874.7" rx="24.71" ry="25.24"
                fill="url(#jointradial)" opacity="1" strokeWidth="0"></ellipse>
            <ellipse cx="419.37" cy="874.7" rx="12.04" ry="12.3" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.46"></ellipse>
            <ellipse cx="241.09" cy="874.7" rx="12.04" ry="12.3" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.46"></ellipse>
        </g>
        <g id="ankles" className="hidden">
            <ellipse id="hover-11" data-name="hover" cx="221.14" cy="1105.65" rx="24.71" ry="25.24"
                fill="url(#jointradial)" opacity="1" strokeWidth="0"></ellipse>
            <ellipse id="hover-12" data-name="hover" cx="439.32" cy="1105.65" rx="24.71" ry="25.24"
                fill="url(#jointradial)" opacity="1" strokeWidth="0"></ellipse>
            <ellipse cx="439.32" cy="1105.65" rx="12.04" ry="12.3" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.46"></ellipse>
            <ellipse cx="221.14" cy="1105.65" rx="12.04" ry="12.3" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.46"></ellipse>
        </g>
    </svg>
  )
