...
export default function FemaleMuscleBack() {
    ...
    <svg viewBox="0 0 660.46 1206.46" fill="none" xmlns="http://www.w3.org/2000/svg"
        ...
        <g>
            <path
                ...
                fill="none" stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.54"></path>
            <path d="M325.87,129.76c-3.85.18-7.32.52-10.42,1.04" fill="none" stroke="none" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.54"></path>
            <path d="M356.13,10.73c79.94,24.39,40.53,149.25,17.44,163.3-22.75,13.85,28.46-42.74-41.48-44.36" fill="none"
                stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.54"></path>
        </g>
        <g id="lowerback" className={`bodymap text-mw-gray active:text-red-700 hover:text-green-950 ${router.query.muscleGrp == 'lowerback' && ('text-green-950')}`} onClick={(e) => getMuscle(e,'female')}>
            <path
        ...
        <g id="triceps" className={`bodymap text-mw-gray active:text-red-700 hover:text-green-950 ${router.query.muscleGrp == 'triceps' && ('text-green-950')}`} onClick={(e) => getMuscle(e, 'female')}>
            <path
        ...
        <g id="hamstrings" className={`bodymap text-mw-gray active:text-red-700 hover:text-green-950 ${router.query.muscleGrp == 'hamstrings' && ('text-green-950')}`} onClick={(e) => getMuscle(e, 'female')}>
            <path
        ...
        <g id="glutes" className={`bodymap text-mw-gray active:text-red-700 hover:text-green-950 ${router.query.muscleGrp == 'glutes' && ('text-green-950')}`} onClick={(e) => getMuscle(e, 'female')}>
            <path
        ...
        <g id="lats" className={`bodymap text-mw-gray active:text-red-700 hover:text-green-950 ${router.query.muscleGrp == 'lats' && ('text-green-950')}`} onClick={(e) => getMuscle(e, 'female')}>
            <path
        ...
        <g id="traps-middle" className={`bodymap text-mw-gray active:text-red-700 hover:text-green-950 ${router.query.muscleGrp == 'traps-middle' && ('text-green-950')}`} onClick={(e) => getMuscle(e, 'female')}>
            <path
        ...
        <g>
            <path d="M256.99,919.42s-.84-33.56-30.2-24.07c-16,5.17-22.57-53.82-31.92-19.23" fill="none" stroke="none"
                strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.54"></path>
            <path d="M127.13,349.54c-8.78,30.8,6.47,10.55,12.79,15.18,6.44,4.72-6.07,44.07,25.78,10.13" fill="none"
                stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.54"></path>
            <path
            ...
            <path
                ...
                fill="none" stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.54"></path>
            <path d="M235.59,470.44c5.34-2.55,11.54-4.1,18.33-5.11,23.46-3.49,75.7-4.21,75.7,58.89" fill="none"
                stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.54"></path>
            <path
            ...
            <path
                ...
                fill="none" stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.54"></path>
            <path d="M285.65,180.23s22.15-10.08,45.27-10.08" fill="none" stroke="none" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.54"></path>
            <line x1="329.62" y1="591.8" x2="329.62" y2="524.22" fill="none" stroke="none" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.54"></line>
            <path d="M403.55,919.42s.84-33.56,30.2-24.07c16,5.17,22.57-53.82,31.92-19.23" fill="none" stroke="none"
                strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.54"></path>
            <path d="M533.41,349.54c8.78,30.8-6.47,10.55-12.79,15.18-6.44,4.72,6.07,44.07-25.78,10.13" fill="none"
                stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.54"></path>
            <path
            ...
            <path
                ...
                fill="none" stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.54"></path>
            <path d="M424.96,470.44c-5.34-2.55-11.54-4.1-18.33-5.11-23.46-3.49-75.7-4.21-75.7,58.89" fill="none"
                stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.54"></path>
            <path
            ...
            <path
                ...
                fill="none" stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.54"></path>
            <path d="M374.89,180.23s-22.15-10.08-45.27-10.08" fill="none" stroke="none" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.54"></path>
            <line x1="330.92" y1="591.8" x2="330.92" y2="524.22" fill="none" stroke="none" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.54"></line>
            <path
            ...
            <path
                ...
                fill="none" stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.54"></path>
            <path d="M265.35,215.12s42.93-7.31,64.27-7.31c22.63,0,66.86,6.77,66.86,6.77" fill="none" stroke="none"
                strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.54"></path>
            <path d="M365.91,175.19c-1.09-8.27-.76-26.61.22-28.46.49-.92,1.28-1.93,2.13-2.99" fill="none"
                stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.54"></path>
            <path d="M292.29,143.8c.82,1.04,1.6,2.03,2.08,2.93.98,1.85,1.31,20.19.22,28.46" fill="none" stroke="none"
                strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.54"></path>
            <path d="M325.87,129.76c2.78-17.69,3.62-37.03,3.62-37.03,0,0,2.51,27.58,2.59,36.94" fill="none"
                stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.54"></path>
            <path d="M309.94,131.94c2.05-15.05,2.45-23.6,2.45-25.65,0-1.94,2.71,21.53,3.06,24.51" fill="none"
                stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.54"></path>
        </g>
        <g id="upper-spine" className="hidden">
            <ellipse id="hover" cx="330.27" cy="188.42" rx="25.59" ry="25.55" fill="url(#jointradial)" opacity="1"
                strokeWidth="0"></ellipse>
            <ellipse cx="330.27" cy="188.42" rx="12.47" ry="12.45" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.54"></ellipse>
        </g>
        <g id="lower-spine" className="hidden">
            <ellipse id="hover-4" data-name="hover" cx="330.27" cy="463.7" rx="25.59" ry="25.55"
                fill="url(#jointradial)" opacity="1" strokeWidth="0"></ellipse>
            <ellipse cx="330.27" cy="463.7" rx="12.47" ry="12.45" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.54"></ellipse>
        </g>
        <g id="scapula" className="hidden">
            <ellipse cx="394.06" cy="251.19" rx="25.59" ry="25.55" fill="url(#jointradial)" opacity="1"
                strokeWidth="0"></ellipse>
            <ellipse cx="266.48" cy="251.19" rx="25.59" ry="25.55" fill="url(#jointradial)" opacity="1"
                strokeWidth="0"></ellipse>
            <ellipse cx="266.48" cy="251.19" rx="12.47" ry="12.45" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.54"></ellipse>
            <ellipse cx="394.06" cy="251.19" rx="12.47" ry="12.45" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.54"></ellipse>
        </g>
        <g id="ankles" className="hidden">
            <ellipse cx="446.54" cy="1137.35" rx="25.59" ry="25.55" fill="url(#jointradial)" opacity="1"
                strokeWidth="0"></ellipse>
            <ellipse cx="214" cy="1137.35" rx="25.59" ry="25.55" fill="url(#jointradial)" opacity="1" strokeWidth="0">
            </ellipse>
            <ellipse cx="214" cy="1137.35" rx="12.47" ry="12.45" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.54"></ellipse>
            <ellipse cx="446.54" cy="1137.35" rx="12.47" ry="12.45" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.54"></ellipse>
        </g>
        <g id="knees" className="hidden">
            <ellipse cx="424.96" cy="861.11" rx="25.59" ry="25.55" fill="url(#jointradial)" opacity="1"
                strokeWidth="0"></ellipse>
            <ellipse cx="235.58" cy="861.11" rx="25.59" ry="25.55" fill="url(#jointradial)" opacity="1"
                strokeWidth="0"></ellipse>
            <ellipse cx="235.58" cy="861.11" rx="12.47" ry="12.45" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.54"></ellipse>
            <ellipse cx="424.96" cy="861.11" rx="12.47" ry="12.45" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.54"></ellipse>
        </g>
        <g id="wrist" className="hidden">
            <ellipse cx="613.94" cy="498.34" rx="25.59" ry="25.55" fill="url(#jointradial)" opacity="1"
                strokeWidth="0"></ellipse>
            <ellipse cx="46.6" cy="498.34" rx="25.59" ry="25.55" fill="url(#jointradial)" opacity="1" strokeWidth="0">
            </ellipse>
            <ellipse cx="46.6" cy="498.34" rx="12.47" ry="12.45" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.54"></ellipse>
            <ellipse cx="613.94" cy="498.34" rx="12.47" ry="12.45" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.54"></ellipse>
        </g>
        <g id="elbow" className="hidden">
            <ellipse cx="135.95" cy="375.09" rx="25.59" ry="25.55" fill="url(#jointradial)" opacity="1"
                strokeWidth="0"></ellipse>
            <ellipse cx="524.59" cy="375.09" rx="25.59" ry="25.55" fill="url(#jointradial)" opacity="1"
                strokeWidth="0"></ellipse>
            <ellipse cx="135.95" cy="375.09" rx="12.47" ry="12.45" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.54"></ellipse>
            <ellipse cx="524.59" cy="375.09" rx="12.47" ry="12.45" fill="currentColor" strokeLinecap="round"
                strokeLinejoin="round" strokeWidth="3.54"></ellipse>
        </g>
    </svg>
  )
