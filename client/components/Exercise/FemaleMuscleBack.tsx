...
export default function FemaleMuscleBack() {
  ...
  return (
    <svg viewBox="0 0 660.46 1206.46" fill="none" xmlns="http://www.w3.org/2000/svg"
        ...
        <g id="lowerback" className="bodymap active:text-green-800 hover:text-green-950" onClick={getMuscle}>
            <path
        ...
        <g id="traps" className="bodymap active:text-green-800 hover:text-green-950" onClick={getMuscle}>
            <path
        ...
        <g id="hands" className="bodymap active:text-green-800 hover:text-green-950" onClick={getMuscle}>
            <path
        ...
        <g id="forearms" className="bodymap active:text-green-800 hover:text-green-950" onClick={getMuscle}>
            <path
        ...
        <g id="triceps" className="bodymap active:text-green-800 hover:text-green-950" onClick={getMuscle}>
            <path
        ...
        <g id="calves" className="bodymap active:text-green-800 hover:text-green-950" onClick={getMuscle}>
            <path
        ...
        <g id="hamstrings" className="bodymap active:text-green-800 hover:text-green-950" onClick={getMuscle}>
            <path
        ...
        <g id="glutes" className="bodymap active:text-green-800 hover:text-green-950" onClick={getMuscle}>
            <path
        ...
        <g id="lats" className="bodymap active:text-green-800 hover:text-green-950" onClick={getMuscle}>
            <path
        ...
        <g id="shoulders" className="bodymap active:text-green-800 hover:text-green-950" onClick={getMuscle}>
            <path
        ...
        <g id="traps-middle" className="bodymap active:text-green-800 hover:text-green-950" onClick={getMuscle}>
            <path
