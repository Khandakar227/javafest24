    ...
    return (
        ...
        <div className={`p-4 py-6 ${enableCam ? 'grid md:grid-cols-2' : ''} gap-4 justify-center items-center`}>
            <div className="relative max-w-xl mx-auto">
                ...
                {
                    enableCam ?
                        <button onClick={stopCam} className="bg-green-500 shadow text-white absolute bottom-2 left-1/2 p-2 rounded-full"><FaVideoSlash size={22} /></button>
                        :
                        <button onClick={startCam} className="bg-green-500 shadow text-white absolute bottom-2 left-1/2 p-2 rounded-full"><FaVideo size={22} /></button>
                }
            </div>
            {
                enableCam && (
