    ...
    return (
        ...
        >
            <div
                ...
                onClick={setShow}
            />
            <div className="bg-white relative  h-screen overflow-auto max-w-60">
                <div className="grid gap-4">
                    {navsmenu.map(({ label, href, icon: Icon }) => (

                        <Link
                            href={href}
                            className={`hover:bg-primary hover:text-white ${router.pathname == href ? "bg-green-700 text-white" : ""
                                }`}
                            key={href}
                        >
