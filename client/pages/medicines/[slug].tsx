        ...
        <div className={`shadow rounded-md px-12 py-12 m-4 bg-white`}>
          {medicine && medicine.medicine && (
            <>
              ...
              <div className="py-6">
                <p style={{ color: "#3a5571" }}>{medicine.medicine.price.replace(/,/g, ' ')}</p>
              </div>
              ...
              <div className="similar-brands inline-block mt-10 margin-b-2">
                  <Link
                    ...
                    href={`/medicines/alternative/${medicine.medicine.generic.replace(/\s+/g, '-')}`}
                    passHref
                  >
              ...
              {medicine.generic && (
                ...
                <p className="ac-body">{medicine.medicine.type.toUpperCase()}</p>
              </div>
