...
export default function Slug() {
    ...
    const [medicine, setMedicine] = useState<{ medicine: Medicine, generic: Generic } | null>(null);
                        ...
                        <>
                            <div className="py-4">
                                <h1 className="text-3xl font-bold"
                                    ...
                                    <small className="h1-subtitle font-normal" style={{
                                        fontSize: "15px",
                                        color: "#777777"
                                    }}>
                            ...
                            <div className="py-6">
                                <p style={{ color: "#3a5571" }}>{medicine.medicine.price}</p>
                            </div>
                            <div className="py-6">
                                ...
                                <div className="py-6">
                                    ...
                                    {medicine.generic.indicationDescription && (
                                        <div className="py-2">
                                            ...
                                            <div className="ac-body" dangerouslySetInnerHTML={{ __html: medicine.generic.indicationDescription }} />
                                        </div>
                                    )}
                                    {medicine.generic.therapeuticClassDescription && (
                                        <div className="py-2">
                                            <h3 className="ac-header">Therapeutic Class</h3>
                                            <div className="ac-body" dangerouslySetInnerHTML={{ __html: medicine.generic.therapeuticClassDescription }} />
                                        </div>
                                    )}
                                    {medicine.generic.pharmacologyDescription && (
                                        <div className="py-2">
                                            <h3 className="ac-header">Pharmacology</h3>
                                            <div className="ac-body" dangerouslySetInnerHTML={{ __html: medicine.generic.pharmacologyDescription }} />
                                        </div>
                                    )}
                                    {medicine.generic.dosageDescription && (
                                        <div className="py-2">
                                            <h3 className="ac-header">Dosage</h3>
                                            <div className="ac-body" dangerouslySetInnerHTML={{ __html: medicine.generic.dosageDescription }} />
                                        </div>
                                    )}
                                    {medicine.generic.administrationDescription && (
                                        <div className="py-2">
                                            <h3 className="ac-header">Administration</h3>
                                            <div className="ac-body" dangerouslySetInnerHTML={{ __html: medicine.generic.administrationDescription }} />
                                        </div>
                                    )}
                                    {medicine.generic.interactionDescription && (
                                        <div className="py-2">
                                            <h3 className="ac-header">Interaction</h3>
                                            <div className="ac-body" dangerouslySetInnerHTML={{ __html: medicine.generic.interactionDescription }} />
                                        </div>
                                    )}
                                    {medicine.generic.contraindicationsDescription && (
                                        <div className="py-2">
                                            <h3 className="ac-header">Contraindications</h3>
                                            <div className="ac-body" dangerouslySetInnerHTML={{ __html: medicine.generic.contraindicationsDescription }} />
                                        </div>
                                    )}
                                    {medicine.generic.sideEffectsDescription && (
                                        <div className="py-2">
                                            <h3 className="ac-header">Side Effects</h3>
                                            <div className="ac-body" dangerouslySetInnerHTML={{ __html: medicine.generic.sideEffectsDescription }} />
                                        </div>
                                    )}
                                    {medicine.generic.pregnancyAndLactationDescription && (
                                        <div className="py-2">
                                            <h3 className="ac-header">Pregnancy And Lactation</h3>
                                            <div className="ac-body" dangerouslySetInnerHTML={{ __html: medicine.generic.pregnancyAndLactationDescription }} />
                                        </div>
                                    )}
                                    {medicine.generic.precautionsDescription && (
                                        <div className="py-2">
                                            <h3 className="ac-header">Precautions</h3>
                                            <div className="ac-body" dangerouslySetInnerHTML={{ __html: medicine.generic.precautionsDescription }} />
                                        </div>
                                    )}
                                    {medicine.generic.pediatricUsageDescription && (
                                        <div className="py-2">
                                            <h3 className="ac-header">Pediatric Usage</h3>
                                            <div className="ac-body" dangerouslySetInnerHTML={{ __html: medicine.generic.pediatricUsageDescription }} />
                                        </div>
                                    )}
                                    {medicine.generic.overdoseEffectsDescription && (
                                        <div className="py-2">
                                            <h3 className="ac-header">Overdose Effects</h3>
                                            <div className="ac-body" dangerouslySetInnerHTML={{ __html: medicine.generic.overdoseEffectsDescription }} />
                                        </div>
                                    )}
                                    {medicine.generic.storageConditionsDescription && (
                                        <div className="py-2">
                                            <h3 className="ac-header">Storage Conditions</h3>
                                            <div className="ac-body" dangerouslySetInnerHTML={{ __html: medicine.generic.storageConditionsDescription }} />
                                        </div>
                                    )}
                                </div>
                            )}
