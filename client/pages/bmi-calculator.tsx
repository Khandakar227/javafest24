...
export default function BmiCalculator() {
  ...
  return (
    <>
      ...
      <Layout>
        <div
          className={`shadow rounded-md px-4 py-8 m-4 bg-white text-center`}
        >
          <h1 className="font-bold md:text-3xl text-2xl">Calculate BMI</h1>
          <p className="mx-auto max-w-7xl text-justify rounded-md py-6 px-4 bg-[#D6EFD8]">
        ...
        >
          <form onSubmit={calculate}>
            ...
            <button className="bg-primary px-4 py-2 rounded hover:text-white">Calculate</button>
          </form>
        ...
        <div className="bg-white p-4 m-4 rounded shadow bg-[#D6EFD8]">
          ...
          <table align="center">
            <tbody className="border-b border-black rounded-2px">
              ...
              <tr><td className="border border-green-900 px-2 py-1">Severe Thinness</td><td className="border border-green-900 px-2 py-1" align="center">&lt; 16</td></tr>
              <tr><td className="border border-green-900 px-2 py-1">Moderate Thinness</td><td className="border border-green-900 px-2 py-1" align="center">16 - 17</td></tr>
              <tr><td className="border border-green-900 px-2 py-1">Mild Thinness</td><td className="border border-green-900 px-2 py-1" align="center">17 - 18.5</td></tr>
              <tr><td className="border border-green-900 px-2 py-1">Normal</td><td className="border border-green-900 px-2 py-1" align="center">18.5 - 25</td></tr>
              <tr><td className="border border-green-900 px-2 py-1">Overweight</td><td className="border border-green-900 px-2 py-1" align="center">25 - 30</td></tr>
              <tr><td className="border border-green-900 px-2 py-1">Obese Class I</td><td className="border border-green-900 px-2 py-1" align="center">30 - 35</td></tr>
              <tr><td className="border border-green-900 px-2 py-1">Obese Class II</td><td className="border border-green-900 px-2 py-1" align="center">35 - 40</td></tr>
              <tr><td className="border border-green-900 px-2 py-1">Obese Class III</td><td className="border border-green-900 px-2 py-1" align="center">&gt; 40</td></tr>
            </tbody>
          </table>
        </div>


        <div className="bg-[#D6EFD8] p-4 m-4 rounded-md shadow">
