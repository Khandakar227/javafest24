            ...
            <Layout>
                <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-r from-green-100 to-indigo-100 py-8">
                    ...
                    <p className="text-lg text-gray-600 text-center max-w-2xl mb-10">
                        ...
                        <br />
                        Select
                        any option below to scan a medicine or medical report and get
                        detailed information instantly.
                    </p>


                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl px-4">
                        <div className="bg-gray-200 rounded-lg shadow-lg p-6 flex flex-col items-center hover:shadow-5xl transition-shadow">
                            <img
                            ...
                            <p className="text-sm text-gray-500 text-center">
                                Scan the medicine to get detailed information including usage,
                                dosage & side effects.
                            </p>
                            <Link href={'/health-scanner/medicine-scanner'} passHref>
                        ...
                        <div className="bg-gray-200 rounded-lg shadow-lg p-6 flex flex-col items-center hover:shadow-5xl transition-shadow">
                            ...
                            <Link href={'/health-scanner/report-scanner'} passHref>
                                <button className="mt-6  bg-gradient-to-r from-green-400 to-indigo-100 text-black-900 px-4 py-2 rounded-lg hover:from-green-500 hover:to-green-800 hover:text-white">
                                    Start Scanning
                                </button>
                            </Link>
